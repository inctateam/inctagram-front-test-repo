  ...
  return (
    ...
    >
      <main className={'flex flex-col gap-8 row-start-2 items-center sm:items-start'}>
        ...
        <ol
          className={
            'hi list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]'
          }
        >
          <li className={'mb-2'}>
      ...
      <footer className={'row-start-3 flex gap-6 flex-wrap items-center justify-center'}>
        ...
        <a
          className={'flex items-center gap-2 hover:underline hover:underline-offset-4'}
          href={
            'https://nextjs.org?utm_source=create-next-app&utm_medium=default-template-tw&utm_campaign=create-next-app'
          }
          rel={'noopener noreferrer'}
          target={'_blank'}
        >
